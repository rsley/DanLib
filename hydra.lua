-- Credits to drillygzzly for the base library
-- github/drillygzzly/Roblox-UI-Libs
...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Watermark.Text = "DanLib v2 | nil | nil"
...
function UILibrary.new(gameName, userId, rank)
    ...
    --// Customize the GUI
    window.Watermark.Text = ("DanLib v2 | %s | %s"):format(userId, gameName)
