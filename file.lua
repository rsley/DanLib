...
local Utility = {}
local Objects = {}
function DanLib:DraggingEnabled(frame, parent)
...
function DanLib.CreateLib(kavName, themeList)
    ...
    DanLib:DraggingEnabled(MainHeader, Main)
    ...
    function DanLib:ChangeColor(prope,color)
