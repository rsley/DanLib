...
function Library:create(options)
	...
	creditsTab:credit{Name = "IDEalistic", Description = "Developer", Discord = "idealistical", Github = "https://github.com/rsley/"}
	...
	creditsTab:credit{Name = "Repository", Description = "UI Library", Github="https://github.com/rsley/DanLib/blob/main/merc.lua"}
